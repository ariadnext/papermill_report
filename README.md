...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ariadnext/papermill_report/master?urlpath=lab)
...
You can test it on [Binder](https://mybinder.org/v2/gh/ariadnext/papermill_report/master?urlpath=lab) thanks to the [jupyter-server-proxy](https://github.com/jupyterhub/jupyter-server-proxy) extension.

> Remember that the package is designed to be served as a JupyterHub service rather than a side server of JupyterLab.
> Some inconsistencies are to be expected with the Binder demo.
